...
setup(
    ...
    install_requires=['adapters>=0.1.1', 'transformers<4.43', 'huggingface_hub<0.26', 'safetensors<0.6', 'protobuf', 'requests', 'torch>=1.6.0', 'tqdm>=4.27', 'langid==1.1.6', 'filelock', 'tokenizers>=0.7.0', 'regex != 2019.12.17', 'packaging', 'sentencepiece', 'sacremoses', 'six'],
    entry_points={
    },
)
